...
export class SigninSignupComponent {
  ...
  user_reg_data: any;
  signInFormValue: any = {};
  @Output() changeVisiableEvent = new EventEmitter<boolean>();
  @Output() changeRegFormEvent = new EventEmitter<boolean>();

  handleChangeVisiable(value: boolean) {
    this.visible = value;
    this.changeVisiableEvent.emit(value);
  }

  handleChangeRegForm(value: boolean) {
    this.regForm = value;
    this.changeRegFormEvent.emit(value);
  }
